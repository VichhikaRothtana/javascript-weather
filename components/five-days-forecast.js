    ...
    this.innerHTML = `
        <div class="container mx-auto space-y-6">
            ...
            ${forecast?.daily.map((f) => {
              return `
                <div
                    class="hover:bg-white card hover:cursor-pointer min-w-[150px] max-w-[200px] bg-gray-100 flex flex-col justify-start items-center p-4">
                    <div class="text-left">
                        <h3 class="upppercase text-teal-500 text-lg font-bold">${milisecondsToDay(
                          f.dt,
